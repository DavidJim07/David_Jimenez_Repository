...
<form action="/proyecto/{{$proyecto->id}}"  method="post" class="form-group">
        @method('PUT')
        @if($errors->any())
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control input-group-lg" id="nombre" name="nombre" value="{{$proyecto->nombre}}">
            </div>
            <div class="mb-3">
                <label class="col-form-label-lg"> Tiempo estimado de Desarrollo</label>
                <input type="text" class="form-control input-group-lg"  id="tiempod" name="tiempod" value="{{$proyecto->tiempoestimado}}">
            </div>
            ...
            <div class="input-group">
                ...
                <input type="date" class="form-control" id="fechaentrega" name="fechaentrega" value="{{$proyecto->fentrega}}"></input>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="requerimientos" name="requerimientos" rows="3">{{$proyecto->requerimientos}}</textarea>
            </div>
        </div>
    </div>
